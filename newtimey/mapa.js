...
function addMarker(latLng,icon,text,id,map){
	...
	var infowindow2 = new google.maps.InfoWindow({
		content:'<p style="color:black">'+text+'</p><br><button onclick=(document.location.href="'+"/newtimey/aemet/tiempo.html?id="+id+'")>'+'Tiempo'+'</button>'
...
async function goTo(a,b,c,url){
	if(!url)url = "/newtimey/aemet/mapa.html";
	if(!a)a = 40.416967;
	if(!b)b = -3.703434;
	if(!c)c = 15;
